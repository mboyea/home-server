...
# ? https://github.com/NixOS/nixpkgs/blob/nixos-24.11/pkgs/build-support/trivial-builders/default.nix#L241
# Usage:
# pkgs.callPackage run.nix {
#   name = "help";
#   target = scripts/help.sh;
# };
# Origin: https://github.com/mboyea/rift-drive
